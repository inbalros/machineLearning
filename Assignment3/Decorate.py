...
def Decorate(base_learn, data,x_names,y_names,gant_flag=False, ensamble_max_size=5, max_iteration=10, R_size=0.1):
...
Decorate(DecisionTreeClassifier(max_depth=5),cars,X_names,y_names)
